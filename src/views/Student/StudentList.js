...
export default function StudentList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const studentData = data.map((value, key) => {
                return _.pick(value, ['id', 'name', 'code', 'birthday', 'address', 'phone', 'email', 'majors', 'schoolYear']);
            });
    ...
    return (
        <GridContainer>
                ...
                <Card>
                    ...
                    <CardBody>
                        <Table
                            ...
                            tableHead={["TT", "Sinh viên", "MSV", "Ngày Sinh", "Địa chỉ", "Đt", "Email", "Chuyên Ngành", "Năm học", ""]}
            ...
            <StudentDialog open={openDialog.open}
                onClose={() => {
                    setDialog({
                        state: "",
                        open: false,
