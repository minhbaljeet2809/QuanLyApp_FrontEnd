  ...
  return (
    <CardBody>
      <GridContainer>
        ...
        <GridItem xs={6} sm={2} md={2}>
          <Box display="flex" alignItems="center" height="100%">
            <p>{projectProgress.studentRate}</p>
          </Box>
        </GridItem>
      </GridContainer>
      <GridContainer>
        ...
        <GridItem xs={6} sm={2} md={2}>
          <Box display="flex" alignItems="center" height="100%">
            <p>{projectProgress.teacherRate}</p>
          </Box>
        </GridItem>
      </GridContainer>
      <GridContainer>
      ...
      <GridContainer>
        ...
        <GridItem xs={6} sm={2} md={2}>
          <Box display="flex" alignItems="center" height="100%">
            <p>{projectProgress.attitudeStudy}</p>
          </Box>
        </GridItem>
      </GridContainer>
      <GridContainer>
        ...
        <GridItem xs={6} sm={2} md={2}>
          <Box display="flex" alignItems="center" height="100%">
            <p>{projectProgress.attWithTeacher}</p>
          </Box>
        </GridItem>
      </GridContainer>
      <GridContainer>
        ...
        <GridItem xs={6} sm={2} md={2}>
          <Box display="flex" alignItems="center" height="100%">
            <p>{projectProgress.abilityRate}</p>
          </Box>
        </GridItem>
      </GridContainer>
      <GridContainer>
